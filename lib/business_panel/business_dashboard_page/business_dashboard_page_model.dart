...
class BusinessDashboardPageModel
    extends FlutterFlowModel<BusinessDashboardPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (HotelsAdd)] action in Button widget.
  ApiCallResponse? apiResultdwr;
