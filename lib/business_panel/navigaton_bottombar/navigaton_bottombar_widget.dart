...
import 'navigaton_bottombar_model.dart';
export 'navigaton_bottombar_model.dart';

/// selectedpage
class NavigatonBottombarWidget extends StatefulWidget {
  const NavigatonBottombarWidget({
    super.key,
    int? selectedpage,
    this.hidden,
  ...
  @override
  State<NavigatonBottombarWidget> createState() =>
      _NavigatonBottombarWidgetState();
}

class _NavigatonBottombarWidgetState extends State<NavigatonBottombarWidget>
    with TickerProviderStateMixin {
  late NavigatonBottombarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NavigatonBottombarModel());
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFF21158A), Color(0xFF272538)],
            stops: [0.0, 1.0],
