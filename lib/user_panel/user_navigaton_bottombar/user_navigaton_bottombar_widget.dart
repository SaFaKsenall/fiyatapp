...
import 'user_navigaton_bottombar_model.dart';
export 'user_navigaton_bottombar_model.dart';

/// selectedpage
class UserNavigatonBottombarWidget extends StatefulWidget {
  const UserNavigatonBottombarWidget({
    super.key,
    int? selectedpage,
    this.hidden,
  ...
  @override
  State<UserNavigatonBottombarWidget> createState() =>
      _UserNavigatonBottombarWidgetState();
}

class _UserNavigatonBottombarWidgetState
    extends State<UserNavigatonBottombarWidget> with TickerProviderStateMixin {
  late UserNavigatonBottombarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserNavigatonBottombarModel());
