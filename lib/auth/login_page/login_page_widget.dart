      ...
      if (FFAppState().isLoggedIn == true) {
        if (FFAppState().userrole == 'admin') {
          ...
          if (FFAppState().userrole == 'user') {
            ...
            if (FFAppState().status == 'pending_verification') {
              context.pushNamed(BusinessPendingWidget.routeName);
            } else {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  _model.apiResultbts =
                                      await AuthApiGroup.loginApiCall.call(
                                    email: _model.textController1.text,
                                    password: _model.textController2.text,
                                  );

                                  FFAppState().authToken = getJsonField(
                                    (_model.apiResultbts?.jsonBody ?? ''),
                                    r'''$.data.accessToken''',
                                  ).toString();
                                  ...
                                  FFAppState().businessName = getJsonField(
                                    (_model.apiResultbts?.jsonBody ?? ''),
                                  ...
                                  FFAppState().uid = getJsonField(
                                    (_model.apiResultbts?.jsonBody ?? ''),
                                    r'''$.data.user.uid''',
                                  ).toString();
                                  safeSetState(() {});
                                  if ((_model.apiResultbts?.succeeded ??
                                      true)) {
                                    if (FFAppState().userrole == 'admin') {
                                      context.pushNamed(
                                      ...
                                      if (FFAppState().userrole == 'user') {
                                        ...
                                        if (FFAppState().status ==
                                            'pending_verification') {
                                          context.pushNamed(
                                              BusinessPendingWidget.routeName);
                                        } else {
                                          context.pushNamed(
