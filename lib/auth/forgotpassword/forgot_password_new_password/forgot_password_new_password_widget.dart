...
class ForgotPasswordNewPasswordWidget extends StatefulWidget {
  const ForgotPasswordNewPasswordWidget({super.key});

  static String routeName = 'ForgotPasswordNewPassword';
  static String routePath = '/forgotPasswordNewPassword';
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().isLoggedIn == true) {
        if (FFAppState().userrole == 'admin') {
          ...
          if (FFAppState().userrole == 'user') {
            context.pushNamed(UserHomePageWidget.routeName);
          } else {
            context.pushNamed(BusinessDashboardPageWidget.routeName);
          }
        }
      }
    });
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Şifrenizi Sıfırlamak İçin Epostanız\'a Gelen 6 Haneli Kodu Girin',
                          textAlign: TextAlign.center,
                          style:
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.textController3.text ==
                                    ...
                                    _model.apiResultgiq = await AuthApiGroup
                                        .resetpasswordotpCall
                                        .call(
                                    ...
                                    if ((_model.apiResultgiq?.succeeded ??
                                        true)) {
